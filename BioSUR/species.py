...
class ReferenceSpecies:
    characteristics: np.ndarray = field(default_factory=lambda: np.array([
        #  name      C    H    O    N    MW    C_frac  H_frac  O_frac  N_frac
        ('CELL',     6,  10,   5,   0,  162, 0.444, 0.062, 0.494, 0.0),
        ('HCELL',    5,   8,   4,   0,  133, 0.455, 0.061, 0.485, 0.0),
        ('LIGC',    15,  14,   4,   0,  258, 0.698, 0.054, 0.248, 0.0),
        ('LIGH',    22,  28,   9,   0,  436, 0.606, 0.064, 0.330, 0.0),
        ('LIGO',    20,  22,  10,   0,  422, 0.569, 0.052, 0.379, 0.0),
        ('TGL',     57, 100,   7,   0,  896, 0.763, 0.112, 0.125, 0.0),
        ('TANN',    15,  12,   7,   0,  304, 0.592, 0.039, 0.368, 0.0),
        # Protein pseudo-species (used only for N-rich characterization)
        ('PROTC',  500, 450,  65,  80, 8620, 0.696, 0.052, 0.121, 0.131),
        ('PROTH',  400, 900, 150,  86, 9316, 0.516, 0.097, 0.258, 0.130),
        ('PROTO',  250, 500, 200,  72, 7715, 0.390, 0.065, 0.415, 0.130),
    ], dtype=[
        ('name', 'U5'),
        ('C', 'i4'),
        ('H', 'i4'),
